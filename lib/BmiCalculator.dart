...
class BMIState extends State<BmiCalculator> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        backgroundColor: Colors.blue, title: new Text ('BMI Kalkulator'),),
      body: new ListView (
...
//dodać widget switch, który będzie przełączał z imerialnego na metryczny razem z widokiem
//dopisać testy kalkulatora
}